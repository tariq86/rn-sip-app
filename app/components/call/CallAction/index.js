    ...
    render() {
        ...
        return (
            <View style={s.container}>
                <TouchableOpacity style={(toggle ? [s.touchable, s.touchableActive] : [s.touchable, s.touchableInactive])} onPress={this.props.onPress}>
                    <Image resizeMode="contain" style={s.image} source={icon}/>
                </TouchableOpacity>
                <Text style={s.text}>{this.props.description}</Text>
            </View>
        )
    }
}
